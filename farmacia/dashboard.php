  ...
  <main>
    <div class="container text-center py-5">
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4 mb-5">
        <div class="col">
          <a href="productos_categoria.php?cat=Cuidado de Piel" class="btn-category">Cuidado de Piel</a>
        </div>
        <div class="col">
          <a href="productos_categoria.php?cat=Belleza" class="btn-category">Belleza</a>
        </div>
        <div class="col">
          <a href="productos_categoria.php?cat=Bebés" class="btn-category">Bebés</a>
        </div>
        <div class="col">
          <a href="productos_categoria.php?cat=Suplementos" class="btn-category">Suplementos</a>
        </div>
        <div class="col">
          <a href="productos_categoria.php?cat=Medicamento con receta" class="btn-category">Medicamento con receta</a>
        </div>
        <div class="col">
          <a href="productos_categoria.php?cat=Medicamento de venta libre" class="btn-category">Medicamento de venta libre</a>
        </div>
        <div class="col">
          <a href="productos_categoria.php?cat=Cuidado capilar" class="btn-category">Cuidado capilar</a>
        </div>
        <div class="col">
          <a href="productos_categoria.php?cat=Fragancia" class="btn-category">Fragancia</a>
        </div>
        <div class="col">
