  ...
  <main>
    <div class="container text-center py-5">
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-4 mb-5">
        <div class="col">
          <a href="productos_categoria.php?cat=Televisores" class="btn-category">Televisores</a>
        </div>
        <div class="col">
          <a href="productos_categoria.php?cat=Celulares y telefonos" class="btn-category">Celulares y telefonos</a>
        </div>
        <div class="col">
          <a href="productos_categoria.php?cat=Informatica" class="btn-category">Informatica</a>
        </div>
        <div class="col">
          <a href="productos_categoria.php?cat=Heladeras" class="btn-category">Heladeras</a>
        </div>
        <div class="col">
          <a href="productos_categoria.php?cat=Climatizacion" class="btn-category">Climatizacion</a>
        </div>
        <div class="col">
          <a href="productos_categoria.php?cat=Cuidado personal" class="btn-category">Cuidado personal</a>
        </div>
        <div class="col">
          <a href="productos_categoria.php?cat=Electrodomesticos" class="btn-category">Electrodomesticos</a>
        </div>
        <div class="col">
          <a href="productos_categoria.php?cat=Herramientas" class="btn-category">Herramientas</a>
        </div>
        <div class="col">
